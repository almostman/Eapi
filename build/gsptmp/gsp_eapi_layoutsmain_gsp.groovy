...
class gsp_eapi_layoutsmain_gsp extends GroovyPage {
...
createTagBody(1, {->
printHtmlPart(5)
expressionOut.print(session.user ==null ? '/eapi' : session.user.admin ? '/eapi/user/admin' : '/eapi/port/list')
printHtmlPart(6)
invokeTag('image','asset',27,['src':("grails-cupsonly-logo-white.svg")],-1)
printHtmlPart(7)
invokeTag('loginControl','g',33,[:],-1)
printHtmlPart(8)
invokeTag('layoutBody','g',40,[:],-1)
printHtmlPart(3)
invokeTag('render','g',42,['template':("/layouts/footer")],-1)
printHtmlPart(9)
invokeTag('message','g',47,['code':("spinner.alt"),'default':("Loading&hellip;")],-1)
printHtmlPart(10)
...
public static final long LAST_MODIFIED = 1480587195492L
