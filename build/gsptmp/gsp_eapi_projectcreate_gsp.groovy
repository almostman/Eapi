...
class gsp_eapi_projectcreate_gsp extends GroovyPage {
...
invokeTag('eachError','g',25,['bean':(this.project),'var':("error")],3)
printHtmlPart(18)
})
invokeTag('hasErrors','g',27,['bean':(this.project)],2)
printHtmlPart(11)
createTagBody(2, {->
printHtmlPart(19)
invokeTag('all','f',30,['bean':("project")],-1)
printHtmlPart(20)
...
public static final long LAST_MODIFIED = 1480496200093L
