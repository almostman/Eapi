...
class gsp_eapi_portcreate_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/port/create.gsp" }
public Object run() {
Writer out = getOut()
...
invokeTag('eachError','g',25,['bean':(this.port),'var':("error")],3)
printHtmlPart(18)
})
invokeTag('hasErrors','g',27,['bean':(this.port)],2)
printHtmlPart(19)
createTagBody(2, {->
printHtmlPart(20)
...
public static final long LAST_MODIFIED = 1480664669519L
