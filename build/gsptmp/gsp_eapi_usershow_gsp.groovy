...
class gsp_eapi_usershow_gsp extends GroovyPage {
...
printHtmlPart(12)
invokeTag('display','f',22,['bean':("user")],-1)
printHtmlPart(12)
createTagBody(2, {->
printHtmlPart(13)
createTagBody(3, {->
...
invokeTag('link','g',25,['class':("edit"),'action':("edit"),'resource':(this.user)],3)
printHtmlPart(14)
...
invokeTag('form','g',28,['resource':(this.user),'method':("DELETE")],2)
printHtmlPart(17)
})
...
public static final long LAST_MODIFIED = 1480472357098L
