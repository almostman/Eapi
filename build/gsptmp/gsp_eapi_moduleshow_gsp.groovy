...
class gsp_eapi_moduleshow_gsp extends GroovyPage {
...
printHtmlPart(12)
invokeTag('display','f',22,['bean':("module")],-1)
printHtmlPart(12)
createTagBody(2, {->
printHtmlPart(13)
createTagBody(3, {->
...
invokeTag('link','g',25,['class':("edit"),'action':("edit"),'resource':(this.module)],3)
printHtmlPart(14)
...
invokeTag('form','g',28,['resource':(this.module),'method':("DELETE")],2)
printHtmlPart(17)
})
...
public static final long LAST_MODIFIED = 1480496221122L
