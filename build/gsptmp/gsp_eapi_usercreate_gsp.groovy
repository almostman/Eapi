...
class gsp_eapi_usercreate_gsp extends GroovyPage {
...
invokeTag('eachError','g',25,['bean':(this.user),'var':("error")],3)
printHtmlPart(18)
})
invokeTag('hasErrors','g',27,['bean':(this.user)],2)
printHtmlPart(11)
createTagBody(2, {->
printHtmlPart(19)
invokeTag('all','f',30,['bean':("user")],-1)
printHtmlPart(20)
...
public static final long LAST_MODIFIED = 1480472357076L
