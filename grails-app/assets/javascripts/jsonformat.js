window.SINGLE_TAB = "  ";
window.ImgCollapsed = "/eapi/assets/Collapsed.gif";
window.ImgExpanded = "/eapi/assets/Expanded.gif";
...
function Process(jsstr, i) {
    ...
    try {
        ...
        $id("Canvas-" + i).innerHTML = "<PRE class='CodeContainer'>" + html + "</PRE>";
    } catch (e) {
        alert("JSON数据格式不正确:\n" + e.message);
        $id("Canvas-" + i).innerHTML = "";
    }
}
...
function SetTab() {
    ...
    window.TAB = MultiplyString(parseInt(1), window.SINGLE_TAB);
